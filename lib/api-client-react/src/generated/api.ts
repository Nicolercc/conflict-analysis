...
export const analyzeArticle = async (
  analyzeArticleBody: AnalyzeArticleBody,
  options?: RequestInit,
): Promise<IntelligenceBrief> => {
  return customFetch<IntelligenceBrief>(getAnalyzeArticleUrl(), {
    ...options,
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(analyzeArticleBody),
  });
};
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    { data: BodyType<AnalyzeArticleBody> },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
...
export type AnalyzeArticleMutationResult = NonNullable<
  Awaited<ReturnType<typeof analyzeArticle>>
>;
export type AnalyzeArticleMutationBody = BodyType<AnalyzeArticleBody>;
